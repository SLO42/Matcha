  ...
  render() {
    ...
    return (
      <form style={{paddingBottom: 10,}}>
        <Button onClick={this.onSubmit} style={styles.button}>Sign In with Google
...
class SignInFacebookBase extends Component {
  ...
  render() {
    ...
    return (
      <form style={{paddingBottom: 10,}}>
        <Button onClick={this.onSubmit} style={styles.button}>Sign In with Facebook <FontAwesomeIcon  style={styles.icon}  size={'2x'} icon={faFacebook} /></Button>
...
class SignInTwitterBase extends Component {
  ...
  render() {
    ...
    return (
      <form>
        <Button onClick={this.onSubmit} style={styles.button}>Sign In with Twitter <FontAwesomeIcon style={styles.icon}  size={'2x'} icon={faTwitter}/></Button>
